...
public enum SocioeconomicArchetype
{
    ...
    /// <summary>
    /// Low income: 12-30 MJ/day (80% biological, 20% technological)
    /// Basic shelter, no vehicle, limited electricity (2-4 hours/day)
    /// </summary>
    LowIncome = 2,

    /// <summary>
    /// Lower-middle income: 30-80 MJ/day (40% biological, 60% technological)
    /// Small apartment/house, may own motorcycle, regular electricity
    /// </summary>
    LowerMiddle = 3,

    /// <summary>
    /// Middle income: 80-200 MJ/day (20% biological, 80% technological)
    /// Owned/rented house, 1 car, 24-hour electricity, partial climate control
    /// </summary>
    Middle = 4,

    /// <summary>
    /// Upper-middle income: 200-400 MJ/day (10% biological, 90% technological)
    /// Owned house, 1-2 cars, full climate control, multiple appliances
    /// </summary>
    UpperMiddle = 5,

    /// <summary>
    /// Affluent: 400-1000+ MJ/day (5% biological, 95% technological)
